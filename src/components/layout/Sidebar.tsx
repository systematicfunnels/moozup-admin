    ...
    <NavLink
      ...
      className={({ isActive }) =>
        cn(
          ...
          isActive ? 'bg-blue-50 text-brand-primary border-r-2 border-brand-primary' : 'text-slate-600'
        )
      }
    >
...
export const Sidebar = ({ items }: { items: SidebarItemProps[] }) => {
  return (
    <aside className="fixed left-0 top-0 h-screen w-[260px] bg-white border-r border-border-subtle z-50">
      <div className="flex h-16 items-center px-6 border-b border-border-subtle">
        <div className="h-8 w-8 bg-brand-primary rounded-s mr-3" />
      ...
      <div className="p-4 border-t border-border-subtle">
        <div className="bg-slate-50 rounded-m p-3">
